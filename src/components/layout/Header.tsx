...
import { ClientNotification } from "../../types.ts";
...
const mockClientNotifications: ClientNotification[] = [
  {
    id: "1",
    type: "service",
    message: "Your GST Filing service is now active.",
  ...
  },
  {
    ...
    type: "document",
    message:
      'A new document "Tax Invoice Q2" has been added by your consultant.',
  ...
  },
  {
    id: "3",
    type: "consultation",
    message: "Reminder: You have a consultation tomorrow at 10 AM.",
  ...
  },
  {
    id: "4",
    type: "announcement",
    message: "New compliance deadlines for 2024 have been announced.",
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div className="hidden lg:block text-left">
              <div className="font-semibold text-sm text-text-primary dark:text-gray-200">
                {clientName || "User"}
              </div>
          ...
          {isProfileMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border dark:border-gray-700 z-50 animate-fade-in-down py-2">
              ...
              <div className="mt-2 space-y-1">
                ...
                >
                  <UserCircleIcon className="w-5 h-5 text-gray-500" /> My
                  Profile
                </a>
              </div>
              <div className="mt-2 pt-2 border-t dark:border-gray-700">
                <a
                  ...
                  className="flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-500/20"
                >
